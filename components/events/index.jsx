                  ...
                  <div class="row no-gutter white-bg blog-item border-0">
                    <div class="col-md-4">
                      <div class="image-part">
                        <Link href="#">
                          <img src="assets/images/destinations/0.png" alt="" />
                        </Link>
                      </div>
                    </div>
                    <div class="col-md-8">
                      <div class="blog-content">
                        <ul class="blog-meta">
                          <li>
                            <small class="border p-2 px-3">
                              <i class="fa-solid fa-calendar-check-o"></i> 8 Aug
                              2023 - 10 Aug 2023
                            </small>
                          </li>
                        </ul>
                        ...
                        <p class="m-0">
                          ...
                          elit. Est debitis similique cum esse iusto, adipisci
                          ab odit sunt totam sequi.
                        </p>
